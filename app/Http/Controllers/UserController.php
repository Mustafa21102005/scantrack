...
class UserController extends Controller
{
    ...
    public function update(UpdateUserRequest $request, User $user)
    {
        ...
        // Check if email is being changed if it is make it unverified
        ...
        $user->update([
            ...
            'password' => $validated['password']
                ...
                : $user->password,
            'email_verified_at' => $user->email_verified_at, // apply cleared/null value if needed
        ]);
    ...
    public function destroy(User $user)
    {
        if ($user->hasRole('lecturer') && $user->teachingCourses->isNotEmpty()) {
            return back()->with('error', 'Cannot delete lecturer, the lecturer is teaching in a course.');
        }
    ...
    {
        $user->enrolledCourses()->attach($request->validated()['course_ids']);
